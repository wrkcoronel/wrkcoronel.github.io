...
const projects = [
  {
    ...
    description:
      'Dashboards e indicadores em Power BI para transformar dados operacionais em decisões mais rápidas.',
  ...
  },
  {
    number: '02',
    title: 'Data Flow',
    type: 'Automação e ETL',
    description:
      'Integrações e rotinas de tratamento de dados conectando planilhas, ERP, SharePoint e relatórios.',
  ...
  },
  {
    ...
    description:
      'Sistema de controle de entregas integrando diferentes áreas e dando visibilidade ao andamento das operações.',
    ...
    <main className="site-shell">
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          <p className="eyebrow">
            data & automation engineer / portfolio
          </p>
          <h1>
            Dados que viram
            <br />
        ...
        <div
          className="hero-art"
          aria-label="Ilustração abstrata de uma janela de código"
        >
          <div className="sun" />
      ...
      <section className="about section" id="sobre">
        ...
        <div className="about-content">
          <h2>Organizo o caos dos dados para revelar o que importa.</h2>
          <div>
            <p>
            ...
            <a className="text-link" href="mailto:pedrogcoronel@outlook.com">
      ...
      <footer className="footer" id="contato">
        ...
        <div className="footer-contact">
          <a href="mailto:pedrogcoronel@outlook.com">
            pedrogcoronel@outlook.com <ArrowUpRight />
          </a>
